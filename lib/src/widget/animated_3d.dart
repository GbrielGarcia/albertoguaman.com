...
class Animater3D extends StatefulWidget {
  final Widget image;
  const Animater3D({Key? key, required this.image}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _Animater3DState();
  }
}

class _Animater3DState extends State<Animater3D> {
